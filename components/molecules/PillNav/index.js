...
const PillNav = ({
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      let currentActive = hashItems[0]?.href;
      ...
      for (const section of sections) {
        ...
        // If we've scrolled past this section, it might be the active one
      ...
      if (
        ...
        currentActive = hashItems[hashItems.length - 1]?.href;
      }
  ...
  }, [items, scrollSpyEnabled, scrollSpyOffset]);
